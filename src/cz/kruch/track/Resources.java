...
/*
    public static final short DESKTOP_MSG_???                   = 1342;
...
/*
    private static final Hashtable table = new Hashtable(192);
*/
        ...
        try {
            ...
            while (entry != null) {
                if (!entry.startsWith("#")) {
                    ...
                    if (i > -1) {
                        Object key = entry.substring(0, i);
                        ...
                        try {
                            key = new Short(Short.parseShort((String) key));
                        } catch (Exception e) {
                            // ignore
                        }
                        table.put(key, value);
