...
public class AndroidAlertUI extends AndroidDisplayableUI implements AlertUI {
	...
	protected boolean isToastable() {
		boolean isToastable = 
				(displayableUnboxed.getType() == null || displayableUnboxed.getType().equals(AlertType.INFO) || displayableUnboxed.getType().equals(AlertType.CONFIRMATION))
	...
	public void showNotify() {
		boolean isToastable = false;
		try {
			isToastable = isToastable();
