 ...
 *  limitations.
 *
 *  @version $Id: AndroidFormUI.java 2215 2009-11-24 08:27:58Z barteo@gmail.com $
 */
...
public class AndroidFormUI extends AndroidDisplayableUI implements FormUI {
	...
	public void set(int itemNum, ItemUI item) {
		org.microemu.log.Logger.warn("Form.set(int itemNum, Item item) NOT IMPLEMENTED YET");
	}
