...
namespace TrackingApp
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            WindowsPhoneRecipes.NonLinearNavigationService.Instance.Initialize(RootFrame);
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            com.codename1.impl.ImplementationFactory.setInstance(new com.codename1.impl.SilverlightImplementationFactory());
            com.codename1.io.Util.setImplementation(com.codename1.impl.SilverlightImplementationFactory.Implementation);
            CN1Extensions.InitLogging();
            CN1Extensions.Log("init", CN1Extensions.Level.INFO);
        }
        ...
        {
            System.Diagnostics.Debug.WriteLine("App.RunningInBackground");
            RunningInBackground = true;
        }
        */
