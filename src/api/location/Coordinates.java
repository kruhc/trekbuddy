 ...
 */
public class Coordinates implements GeodeticPosition {

    public static final Coordinates INVALID;
    ...
    protected static final double FLATTENING_WGS84 = 1D / 298.257223563;
...
//#endif
    ...
    public static Coordinates createInstance(final double lat, final double lon) {
        return createInstance(lat, lon, Float.NaN);
    }

    public static Coordinates createInstance(final double lat, final double lon, final float alt) {
...
//#endif
    ...
    public static void releaseInstance(final Coordinates c) {
//#ifndef __NOBJPOOL__
        if (c != null && c != INVALID) {
            synchronized (pool) {
...
//#endif
    ...
    public Coordinates _clone() {
        return createInstance(lat, lon, alt);
    }

    public void copyFrom(final Coordinates qc) {
        this.lat = qc.lat;
        this.lon = qc.lon;
        this.alt = qc.alt;
    }
    ...
    public final void setAlt(float alt) {
        this.alt = alt;
    }

    public final float azimuthTo(final Coordinates to) {
        double result = 0D;
    ...
    public final float distance(final Coordinates to) {
    ...
    public static Coordinates project(final Coordinates from,
        ...
        return createInstance(latitude, longitude);
    }
}