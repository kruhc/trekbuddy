...
public class MIDletBridge {
  ...
  static MIDletAccess midletAccess;
	...
	public static void registerMIDletAccess(MIDletAccess accessor) {
		...
		c.setMIDletAccess(midletAccess = accessor);
...
*/    
    if (midletAccess != null && midletAccess.midlet != midlet) {
      throw new IllegalStateException("Only single midlet instance is supported");
    }
    return midletAccess;
	}
	...
	static Map /*<GameCanvas, GameCanvasKeyAccess>*/ gameCanvasAccesses = new HashMap();	
